...
public class Herramienta {
    ...
    public boolean actualizarHerramienta() {
        ...
        if (conexion.setAutoCommitBD(false)) {
            ...
            String sql2 = "UPDATE `Herramientas` SET " + "',nombre='" + this.nombre + "',descripcion='" + this.descripcion + "',cantidad='" + this.cantidad + "',codigo='" + this.codigo
                    + "' WHERE `idherramientas`='" + this.idherramientas + "'";
