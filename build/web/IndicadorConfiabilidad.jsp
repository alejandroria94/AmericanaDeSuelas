            ...
            var app = {
                ...
                init: function () {
                    ...
                    app._chart = new Highcharts.Chart({
                        ...
                        tooltip: {
                            pointFormat: '<span><strong>Dia {point.name}</strong></span>-> <strong><b style="color:red; font-size:16px;">{point.y}</b> </strong> Horas promedio de uso<br/>'
                        },
                        xAxis: {
                            title: {
                                text: 'Día del Mes'
                    ...
                    app._chart2 = new Highcharts.Chart({
                        ...
                        tooltip: {
                            valueSuffix: ' Horas promedio de uso'
                        }
                    });
